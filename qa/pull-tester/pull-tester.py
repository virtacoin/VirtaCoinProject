...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old VirtaCoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/VirtaCoindComparisonTool_jar/VirtaCoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/virtacoin/VirtaCoinProject.git")
...
environ_default("BUILD_PATH", "/mnt/virtacoin")
...
environ_default("GITHUB_REPO", "virtacoin/virtacoin")
