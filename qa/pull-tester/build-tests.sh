...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /home/scott/Desktop/virtacoin/win32-build/src/virtacoind.exe $OUT_DIR/virtacoind.exe
  cp /home/scott/Desktop/virtacoin/win32-build/src/test/test_virtacoin.exe $OUT_DIR/test_virtacoin.exe
  cp /home/scott/Desktop/virtacoin/win32-build/src/qt/virtacoind-qt.exe $OUT_DIR/virtacoin-qt.exe
  # Linux:
  cp /home/scott/Desktop/virtacoin/linux-build/src/virtacoind $OUT_DIR/virtacoind
  cp /home/scott/Desktop/virtacoin/linux-build/src/test/test_virtacoin $OUT_DIR/test_virtacoin
  cp /home/scott/Desktop/virtacoin/linux-build/src/qt/virtacoind-qt $OUT_DIR/virtacoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /home/scott/Desktop/virtacoin/linux-build
make check

# Run RPC integration test on Linux:
/home/scott/Desktop/virtacoin/qa/rpc-tests/wallet.sh /home/scott/Desktop/virtacoin/linux-build/src

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /home/scott/Desktop/virtacoin/win32-build
  make check
fi
