...
{
    BOOST_CHECK(TestSplitHost("www.virtacoin.com", "www.virtacoin.com", -1));
    BOOST_CHECK(TestSplitHost("[www.virtacoin.com]", "www.virtacoin.com", -1));
    BOOST_CHECK(TestSplitHost("www.virtacoin.com:80", "www.virtacoin.com", 80));
    BOOST_CHECK(TestSplitHost("[www.virtacoin.com]:80", "www.virtacoin.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:22816", "127.0.0.1", 22816));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:22816", "127.0.0.1", 22816));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:22816", "::ffff:127.0.0.1", 22816));
    BOOST_CHECK(TestSplitHost("[::]:22816", "::", 22816));
    BOOST_CHECK(TestSplitHost("::22816", "::22816", -1));
    BOOST_CHECK(TestSplitHost(":22816", "", 22816));
    BOOST_CHECK(TestSplitHost("[]:22816", "", 22816));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:22816", "127.0.0.1:22816"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:22816", "[::]:22816"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
