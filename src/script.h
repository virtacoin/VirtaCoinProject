...
#ifndef H_VIRTACOIN_SCRIPT
#define H_VIRTACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVirtaCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, VirtaCoin always counted CHECKMULTISIGs
