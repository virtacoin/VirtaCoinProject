...
#ifndef _VIRTACOINRPC_CLIENT_H_
#define _VIRTACOINRPC_CLIENT_H_ 1
...
/** Show help message for virtacoin-cli.
 ...
 *
 * @note the argument can be removed once virtacoin-cli functionality is removed from virtacoind
 */
