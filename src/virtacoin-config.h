/* src/virtacoin-config.h.  Generated from virtacoin-config.h.in by configure.  */
/* src/virtacoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VIRTACOIN_CONFIG_H

#define VIRTACOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "support@virtacoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VirtaCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VirtaCoin Core 2.9.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "virtacoin"
