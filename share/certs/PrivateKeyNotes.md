...
unlocked to sign the VirtaCoin-Qt.app bundle.
...
allowing somebody to distribute a VirtaCoin-Qt.app or virtacoin-qt-setup.exe with a valid
...
that the virtacoin-qt.exe file inside the installer had not been tampered with.
